...
// Moonveil ships without an inherited telemetry endpoint. Operators can opt in
// explicitly by providing their own VITE_SENTRY_DSN at build time.
if (sentryDsn) {
  Sentry.init({
    dsn: sentryDsn,
    enabled: true,
  ...
  Sentry.metrics.count("app_open", 1, {
    attributes: { env: import.meta.env.MODE },
  });
}
